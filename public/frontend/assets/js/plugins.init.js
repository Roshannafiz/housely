...
try {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        document.querySelectorAll('[data-tabs-toogle]').forEach(triggerEl => {
...
try {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        let modalInstances = []
        document.querySelectorAll('[data-modal-toogle]').forEach(el => {
            const modalId = el.getAttribute('data-modal-toogle');
