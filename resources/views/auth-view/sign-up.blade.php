    ...
    <div class="container z-3">
        <div class="flex justify-center">
            <div
                ...
                <a href="{{ url('/') }}"><img src="{{ asset('frontend/assets/images/logo-icon-64.png') }}"
                                              class="mx-auto" alt=""></a>
                ...
                <form action="{{ route('register') }}" method="POST" class="text-left">
                    ...
                    <div class="grid grid-cols-1">
                        <div class="mb-4">
                            ...
                            <input id="RegisterName" name="name" value="{{ old('name') }}" type="text" class="form-input mt-3"
                                   placeholder="Harry">
                            <div class="py-2">
                                @if ($errors->has('name'))
                        ...
                        <div class="mb-4">
                            ...
                            <input id="LoginEmail" name="email" value="{{ old('email') }}" type="email" class="form-input mt-3"
                        ...
                        <div class="mb-4">
                            <div class="form-checkbox flex items-center mb-0">
                                <input name="terms_condition" class="mr-2 border border-inherit w-[14px] h-[14px]"
                            ...
                            <div class="py-2">
                                @if ($errors->has('terms_condition'))
                                    <span style="color: red">{{ $errors->first('terms_condition') }}</span>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            <button type="submit"
                                    class="btn bg-green-600 hover:bg-green-700 text-white rounded-md w-full">Register
                            </button>
                        </div>
