        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card shadow p-5">
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12 mt-5">
                                <h3 class="page-title mt-3">How To Work Update</h3>
                                <ul class="breadcrumb">
                    ...
                    <div class="card-body">
                        <form action="{{ url('work-update/' . $work->id) }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" name="icon_code" value="{{ $work->icon_code }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <textarea name="description" class="form-control" placeholder="Description"
                                                      cols="30"
                                                      rows="5">{!! $work->description !!}</textarea>
                                            <div class="error-message">
                                                @error('description')
                                                <span>! {{ $message }}</span>
                                                @enderror
