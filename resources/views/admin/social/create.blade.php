                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-sm-12 mt-5">
                                <h3 class="page-title mt-3">Social Create</h3>
                                <ul class="breadcrumb">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" name="social_name" placeholder="Social Name"
                                                               class="form-control" value="{{ old('social_name') }}">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" name="icon_code" placeholder="Icon Code"
                                                               class="form-control" value="{{ old('icon_code') }}">
                                                        <div class="error-message">
                                                            @error('icon_code')
                                                            <span>! {{ $message }}</span>
                                                            @enderror
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="text" name="icon_link" placeholder="Icon Link"
                                                               class="form-control" value="{{ old('icon_link') }}">
                                                        <div class="error-message">
                                                            @error('icon_link')
                                                            <span>! {{ $message }}</span>
                                                            @enderror
